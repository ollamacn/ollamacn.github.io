...
download_and_extract "https://tvv.tw/https://github.com/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}"
...
if [ -f /etc/nv_tegra_release ] ; then
    if grep R36 /etc/nv_tegra_release > /dev/null ; then
        download_and_extract "https://tvv.tw/https://github.com/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}-jetpack6"
    elif grep R35 /etc/nv_tegra_release > /dev/null ; then
        download_and_extract "https://tvv.tw/https://github.com/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}-jetpack5"
    else
...
if check_gpu lspci amdgpu || check_gpu lshw amdgpu; then
    download_and_extract "https://tvv.tw/https://github.com/ollama/ollama/releases/latest/download" "$OLLAMA_INSTALL_DIR" "ollama-linux-${ARCH}-rocm"
